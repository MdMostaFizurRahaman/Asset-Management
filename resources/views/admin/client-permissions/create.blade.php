...
<div class="content-wrapper" style="">
    ...
    <section class="content-header">
        <h1> Add New Client Permission </h1>
        <ol class="breadcrumb">
        </ol>
    </section>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">New Client Permission Info</h3>
                    </div>

                    @include('include.error')

                    {!! Form::open(['method'=>'POST', 'action'=>'admin\ClientPermissionController@store', 'files'=>true]) !!}
                    ...
                    <div class="box-body">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    {!! Form::checkbox('permissions[]', $permissionId, null, ['class'=>'check', 'id'=>'permissionId' . $permissionId]) !!}
