            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box">
                        ...
                        {!! Form::open(['method'=>'GET', 'action'=>['client\AssetController@archive', $subdomain]]) !!}
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control multiple" name="guarantee">
                                            ...
                                            @for($i=1; $i<=100; $i++)
                                                <option value="{{ $i }}"
                                                        @if($i == Request::input('guarantee')) selected="selected" @endif>{{ $i }}</option>
                                            @endfor
                                        </select>
                                    </div>
                                </div>
                                ...
                                @foreach($assets as $asset)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <a data-fancybox="gallery" data-caption="{{ $asset->title }}"
                                               href="{{ asset(Helper::storagePath($asset->qr_code_image)) }}">
                                                <img style="width: 100px;"
                                                     src="{{ asset(Helper::storagePath($asset->qr_code_image)) }}"
                                                     alt="">
                                            </a>
                                        </td>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            @if(Auth::user()->hasRole('admin') || Auth::user()->can('client-assets-show'))
                                                <a href="{{ route('client.assets.logs', [$subdomain, $asset->id]) }}"
