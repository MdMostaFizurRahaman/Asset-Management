                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">New Asset Info</h3>
                        </div>

                        @include('include.error')

                        {!! Form::open(['method'=>'POST', 'action'=>['client\AssetController@store', $subdomain], 'files'=>true]) !!}
                        ...
                        <div class="box-body">
                            <div class="col-md-6">
                                ...
                                <div id="depreciation" style="display: {{ $display ? 'block': 'none' }}">
                                    <div class="form-group">
