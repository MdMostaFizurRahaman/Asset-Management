        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    {!! Form::open(['method'=>'GET', 'action'=>['admin\AssetServiceController@index']]) !!}
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('admin.asset-services.edit', $assetservice->id) }}" class="btn btn-default btn-sm" title="Edit"><i class="fa fa-edit"></i></a>
                                    @endif
                                    ...
                                    {!! Form::open(['method'=>'DELETE', 'action'=>['admin\AssetServiceController@destroy', $assetservice->id], 'id'=>'deleteForm'.$assetservice->id]) !!}
                                    {!! Form::close() !!}
                                    @endif
