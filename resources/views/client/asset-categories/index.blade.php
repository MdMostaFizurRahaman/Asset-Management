        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    {!! Form::open(['method'=>'GET', 'action'=>['client\AssetCategoryController@index', $subdomain]]) !!}
                    ...
                    <div class="box-body table-responsive ">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($assetcategory->public <> 1)
                                    @if(Auth::user()->hasRole('admin') || Auth::user()->can('client-asset-categories-update'))
                                    <a href="{{ route('client.asset-categories.edit', [$subdomain, $assetcategory->id]) }}" class="btn btn-default btn-sm" title="Edit"><i class="fa fa-edit"></i></a>
                                    @endif
                                    ...
                                    {!! Form::open(['method'=>'DELETE', 'action'=>['client\AssetCategoryController@destroy', $subdomain, $assetcategory->id], 'id'=>'deleteForm'.$assetcategory->id]) !!}
                                    {!! Form::close() !!}
                                    @endif
                                    @endif
