            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <!-- /.box-header -->
                        <div class="box-body table-responsive ">
                            <table class="table table-bordered table-hover">
                                <tr>
                                    ...
                                    <th class="" style="min-width:50px;">Assign User</th>
                        ...
                        <!-- /.box-body -->
                        {!! Form::open(['method'=>'POST', 'action'=>['client\AssetController@returnrejectstore', $subdomain, $asset->id]]) !!}
                        <div class="box-body">

                            <div class="col-md-6">
                                <div class="form-group">
                                    {!! Form::label('reject_note', 'Return Rejection Note') !!}
                                    {!! Form::textarea('reject_note', null, ['class'=>'form-control resize-vertical', 'size' => '30x4']) !!}
                                </div>
                            </div>
