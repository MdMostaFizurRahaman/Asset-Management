            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <!-- /.box-header -->
                        ...
                        <!-- /.box-body -->
                        {!! Form::open(['method'=>'POST', 'action'=>['client\ClientController@assetrejectstore', $subdomain, $asset->id]]) !!}
                        <div class="box-body">
                            <div class="col-md-6">
                                <div class="form-group">
                                    {!! Form::label('reject_note', 'Rejection Note') !!}
