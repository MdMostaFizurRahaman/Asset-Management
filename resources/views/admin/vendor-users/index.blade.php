            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Vendor User List</h3>
                    </div>

                    @include('include.flashMessage')
                    @include('include.error')

                    {!! Form::open(['method'=>'GET', 'action'=>['admin\VendorController@index']]) !!}
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('admin.vendor-users.edit', $vendor->id) }}" class="btn btn-default btn-sm" title="Edit"><i class="fa fa-edit"></i></a>
                                    <a href="{{ route('admin.vendor-users.resetPassword', $vendor->id) }}" class="btn btn-default btn-sm" title="Change Password"><i class="fa fa-unlock-alt"></i></a>
                                    @endif
                                    ...
                                    {!! Form::open(['method'=>'DELETE', 'action'=>['admin\VendorController@destroy', $vendor->id], 'id'=>'deleteForm'.$vendor->id]) !!}
                                    {!! Form::close() !!}
                                    @endif
                    ...
                    <div class="box-footer clearfix">
                        <ul class="pagination pagination-sm no-margin pull-right">
                            Page {{ $vendors->currentPage() }}  , showing {{ $vendors->count() }} records out of {{ $vendors->total() }} total
                        </ul>
                    </div>
