            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">New Client Info</h3>
                    </div>

                    @include('include.error')

                    {!! Form::open(['method'=>'POST', 'action'=>'admin\ClientController@store', 'files'=>true]) !!}
                    ...
                    <div class="box-body">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::select('status', [''=>'Choose an option'] + Config::get('constants.ACTIVE_CLIENT_STATUSES'), null, ['class'=>'form-control']) !!}
                            </div>
