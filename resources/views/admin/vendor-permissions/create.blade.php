...
<div class="content-wrapper" style="">
    ...
    <section class="content-header">
        <h1> Add New Vendor Permission </h1>
        <ol class="breadcrumb">
        </ol>
    </section>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">New Vendor Permission Info</h3>
                    </div>

                    @include('include.error')

                    {!! Form::open(['method'=>'POST', 'action'=>'admin\VendorPermissionController@store', 'files'=>true]) !!}
