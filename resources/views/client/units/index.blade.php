        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    {!! Form::open(['method'=>'GET', 'action'=>['client\UnitController@index', $subdomain]]) !!}
                    ...
                    <div class="box-body table-responsive ">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>{{ $unit->title }}</td>
                                <td>{!! Helper::activeStatuslabel($unit->status) !!}</td>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('client.units.edit', [$subdomain, $unit->id]) }}" class="btn btn-default btn-sm" title="Edit"><i class="fa fa-edit"></i></a>
                                    @endif
                                    ...
                                    {!! Form::open(['method'=>'DELETE', 'action'=>['client\UnitController@destroy', $subdomain, $unit->id], 'id'=>'deleteForm'.$unit->id]) !!}
                                    {!! Form::close() !!}
                                    @endif
                    ...
                    <div class="box-footer clearfix">
                        <ul class="pagination pagination-sm no-margin pull-right">
                            Page {{ $units->currentPage() }}  , showing {{ $units->count() }} records out of {{ $units->total() }} total
                        </ul>
                    </div>
