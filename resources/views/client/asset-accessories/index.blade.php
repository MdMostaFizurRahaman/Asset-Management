        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    {!! Form::open(['method'=>'GET', 'action'=>['client\AssetAccessoryController@index', $subdomain]]) !!}
                    ...
                    <div class="box-body table-responsive ">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($assethardware->public <> 1)
                                    @if(Auth::user()->hasRole('admin') || Auth::user()->can('client-asset-hardwares-update'))
                                    <a href="{{ route('client.asset-accessories.edit', [$subdomain, $assethardware->id]) }}" class="btn btn-default btn-sm" title="Edit"><i class="fa fa-edit"></i></a>
                                    @endif
                                    ...
                                    {!! Form::open(['method'=>'DELETE', 'action'=>['client\AssetAccessoryController@destroy', $subdomain, $assethardware->id], 'id'=>'deleteForm'.$assethardware->id]) !!}
                                    {!! Form::close() !!}
                                    @endif
                                    @endif
                    ...
                    <div class="box-footer clearfix">
                        <ul class="pagination pagination-sm no-margin pull-right">
                            {{$assethardwares->appends(request()->all())->links()}}
                        </ul>
                    </div>
