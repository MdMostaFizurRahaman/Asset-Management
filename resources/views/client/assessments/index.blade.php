        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    {!! Form::open(['method'=>'GET', 'action'=>['client\AssessmentController@index', $subdomain]]) !!}
                    ...
                    <div class="box-body table-responsive ">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('client.assessments.timeline', [$subdomain, $assessment->id]) }}" class="btn btn-default btn-sm"  title="Timeline"><i class="fa fa-eye"></i></a>
                                </td>
                            </tr>
                            @endforeach
