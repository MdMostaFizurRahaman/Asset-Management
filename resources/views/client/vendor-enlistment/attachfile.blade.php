                ...
                <div class="col-md-12">
                    ...
                    <!-- /.box-header -->
                        ...
                        @if(Auth::user()->hasRole('admin') || Auth::user()->can('client-vendor-enlistment-update'))
                            ...
                            {!! Form::open(['method'=>'POST', 'action'=>['client\VendorEnlistmentController@attachfilestore', $subdomain, $enlistvendor->id], 'files'=>true]) !!}
                            <div class="box-body">
                        ...
                        <div class="box-body table-responsive ">
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    <td>{{ $attachment->id }}</td>
                                    <td>
                                        <a target="_blank" href="{{ Helper::storagePath($attachment->filename) }}">{{ $attachment->title }}</a>
                                    </td>
                                    ...
                                    <td>
                                        @if(Auth::user()->hasRole('admin') || Auth::user()->can('client-vendor-enlistment-attachment-delete'))
                                            ...
                                            {!! Form::open(['method'=>'DELETE', 'action'=>['client\VendorEnlistmentController@attachmentdestroy', $subdomain, $attachment->id], 'id'=>'deleteForm'.$attachment->id]) !!}
                                            {!! Form::close() !!}
                                        @endif
