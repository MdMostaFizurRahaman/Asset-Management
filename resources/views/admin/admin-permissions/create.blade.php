...
<div class="content-wrapper" style="">
    ...
    <section class="content-header">
        <h1> Add New Admin Permission </h1>
        <ol class="breadcrumb">
        </ol>
    </section>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">New Admin Permission Info</h3>
                    </div>

                    @include('include.error')

                    {!! Form::open(['method'=>'POST', 'action'=>'admin\AdminPermissionController@store', 'files'=>true]) !!}
