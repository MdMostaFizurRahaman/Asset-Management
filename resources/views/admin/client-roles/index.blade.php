        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">Client Roles List</h3>
                    </div>
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('admin.client-roles.edit', [$client->id, $role->id]) }}" class="btn btn-default btn-sm" title="Edit"><i class="fa fa-edit"></i></a>
                                    @endif
                                    ...
                                    {!! Form::open(['method'=>'DELETE', 'action'=>['admin\ClientRoleController@destroy', $client->id, $role->id], 'id'=>'deleteForm'.$role->id]) !!}
                                    {!! Form::close() !!}
                                    @endif
                                    @endif
                                </td>
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">New Client Role</h3>
                    </div>

                    {!! Form::open(['method'=>'POST', 'action'=>['admin\ClientRoleController@store', $client->id]]) !!}
