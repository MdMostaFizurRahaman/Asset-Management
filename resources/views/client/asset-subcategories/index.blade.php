            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Asset SubCategory List</h3>
                    </div>

                    @include('include.flashMessage')
                    @include('include.error')

                    {!! Form::open(['method'=>'GET', 'action'=>['client\AssetSubCategoryController@index', $subdomain]]) !!}
                    ...
                    <div class="box-body table-responsive ">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($assetsubcategory->public <> 1)
                                    @if(Auth::user()->hasRole('admin') || Auth::user()->can('client-asset-subcategories-update'))
                                    <a href="{{ route('client.asset-subcategories.edit', [$subdomain, $assetsubcategory->id]) }}" class="btn btn-default btn-sm" title="Edit"><i class="fa fa-edit"></i></a>
                                    @endif
                                    ...
                                    <a href="#" class="btn btn-default btn-sm" title="Delete"
                                       onclick="if (confirm(&quot;Are you sure you want to delete ?&quot;)) { document.getElementById('deleteForm{{ $assetsubcategory->id }}').submit(); } event.returnValue = false; return false;"><i
                                            class="fa fa-trash"></i></a>

                                    {!! Form::open(['method'=>'DELETE', 'action'=>['client\AssetSubCategoryController@destroy', $subdomain, $assetsubcategory->id], 'id'=>'deleteForm'.$assetsubcategory->id]) !!}
                                    {!! Form::close() !!}
                                    @endif
                                    @endif
